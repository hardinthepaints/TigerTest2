...
import com.xanderfehsenfeld.tigertest.Service.DB.MyDbWrapper;
...
public class SpeedTestLauncher extends Activity {
    ...
    public static final int CLICK_STRT_BTN = 267;
...
//        b.setHeight(radius * 2);
        ...
        relativeLayoutParams = new RelativeLayout.LayoutParams(radius * 3, radius * 3);
        relativeLayoutParams.addRule( RelativeLayout.CENTER_IN_PARENT );
...
//        loader.setMinimumHeight( radius * 2 + 10 );
    ...
    public class MyResultReceiver extends ResultReceiver
    {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            } else if (resultCode == DataGatherService.MSG_TEST_STOPPED) {
                changeUI(UI_MODE_NOT_TESTING);
                Log.e(TAG, "receivered result: MSG_TEST_STOPPED");
            } else if (resultCode == CLICK_STRT_BTN) {
                if (currentUIMode == UI_MODE_NOT_TESTING) mBtnStart.performClick();
                else throw new IllegalStateException("data gather serviced called click start button while testing");
     ...
     *      UI_MODE_NOT_TESTING - app appears not to be carrying out a test
     *      Note that changing the ui in no way starts or stops a test
     */
    protected void changeUI(int mode){
        ...
        if (mode == UI_MODE_TESTING){
            ...
            (settingsPwindo.getContentView().findViewById(R.id.time_limit_seekbar)).setEnabled(false);

            //mBtnStart.setEnabled(false);
            //mBtnStart.setText("TESTING...");
            mBtnStart.setBackground(getResources().getDrawable(R.drawable.start_btn_pressedb));

            loader.setVisibility(View.VISIBLE);
            //loader.startAnimation(AnimationUtils.loadAnimation(this, R.anim.popup_show));
            ...
            /* re-enable slider */
            (settingsPwindo.getContentView().findViewById(R.id.time_limit_seekbar)).setEnabled(true);

            loader.setVisibility(View.INVISIBLE);
            loader.clearAnimation();
            loader.startAnimation(AnimationUtils.loadAnimation(this, R.anim.popup_hide));
	...
	void prepareData(){
        ...
        z = data.get(FeedReaderDbHelper.TEST_COUNT);
        tv_test_number.setText(z);
        adjustTextView(tv_test_number);
