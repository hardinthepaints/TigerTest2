 ...
 *
 * A wrapper class for a shared preferences object. Allows less code to get values and set values in the shared preferences
 */
public class MySharedPrefsWrapper {
    ...
    private void initPrefs(){
        ...
        if (!prefs.getBoolean(DEFAULTS_SET, false)) {
            ...
            prefEditer.putInt(PREF_TIME_LIMIT, 30);
    ...
    public int getConnTimeout() {return prefs.getInt(PREF_CONNECT_TIME_LIMIT, 0);}
    public int getTimeLimit() {return prefs.getInt(PREF_TIME_LIMIT, 0);}
}
